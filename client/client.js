var soc, self, drawFrame, bd, bde, width, height, players, mobile, body,
mouseDown = false,
...
window.mobileAndTabletcheck = function() { // detectmobilebrowsers.com
  var check = false;
...
window.onload = function() {
    ...
    if (mobile) {
        body.setAttribute("onwheel", "  cameraX += event.deltaX / tileSize;" +
                                     "  cameraY += event.deltaY / tileSize;");
    }
    var resetDimensions = function() {
        if (mobile) {
            viewScale += window.innerWidth - width;
        }
